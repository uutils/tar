...
/// * [`UCommand::with_util`]: Run `sed UTIL_NAME` instead of the shell
/// * [`UCommand::from_test_scenario`]: Run `sed UTIL_NAME` instead of the shell in the
...
impl UCommand {
    ...
    /// execution binary is set to `sed`.
...
mod tests {
    ...
    // See also https://github.com/uutils/procps/issues/3895
    #[cfg(feature = "tail")]
    #[test]
